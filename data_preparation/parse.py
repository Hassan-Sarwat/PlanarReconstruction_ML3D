...
ROOT_FOLDER = '/home/steve/Documents/ml3d/Project/Data/scans/'
...
def loadClassMap():
    classMap = {}
    classLabelMap = {}
    with open('/home/steve/Documents/ml3d/Project/Data/scannetv2-labels.combined.tsv') as info_file:
        line_index = 0
...
if __name__=='__main__':
    ...
    for scene_id in scene_ids:
        ...
        if len(glob.glob(ROOT_FOLDER + '/' + scene_id + '/annotation/segmentation/*.png')) < len(glob.glob(ROOT_FOLDER + '/' + scene_id + '/frames/pose/*.txt')):
            cmd = '/home/steve/Documents/ml3d/Project/PlaneNet/data_preparation/Renderer/Renderer --scene_id=' + scene_id + ' --root_folder=' + ROOT_FOLDER
            os.system(cmd)
            pass
        continue
